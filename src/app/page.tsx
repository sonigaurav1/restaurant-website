          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full flex-col justify-center max-w-[650px]">
              <div className="mt-[23px] max-w-[650px] w-full flex justify-end">
                <div className="bg-white w-[250px] rounded-[10px] text-black py-4 px-6 hidden sm:block">
                  <h3 className="font-normal tracking-wide">Opening Hours</h3>
                  <div className="mt-2 flex justify-between items-center">
                    <h2 className="">Mon - Fri</h2>
                    <p className="font-normal tracking-wide">11 AM - 11 PM</p>
                  </div>
                  <div className="mt-2 flex justify-between items-center">
                    <h2 className="">Sat - Sun</h2>
                    <p className="font-normal tracking-wide">10 AM - 11 PM</p>
                  </div>
                </div>
              </div>
              <NavigationFooter />
